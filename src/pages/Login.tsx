...
export const Login: React.FC = () => {
  ...
  React.useEffect(() => {
    // Check if the URL has an error from Supabase OAuth redirect
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-950 text-zinc-50 p-4">
      <div className="max-w-md w-full space-y-8 p-8 border border-zinc-800 rounded-2xl bg-zinc-900/50 backdrop-blur-sm shadow-2xl relative overflow-hidden">
        ...
        <div className="text-center">
          ...
          <h2 className="text-3xl font-bold tracking-tight mb-2">FinFlow</h2>
          <p className="text-zinc-400 text-sm">A smart, automated personal finance and budget manager.</p>
        </div>

        <div className="mt-8">
          <Button 
            className="w-full bg-white text-zinc-900 hover:bg-zinc-200 h-12 text-base font-medium transition-all" 
